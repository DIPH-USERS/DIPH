...
public class Form3Define {
	...
	public Form3Define(String form_3_checkdate, String form_3_meeting_venue, String form_3_filled_by,
			...
			List<Form3DefineCommonArray> policy_array, List<String> first_service_document_action_required,
			...
			List<String> first_policy_document_action_required, String source) {
	...
	public String toString() {
		return "Form3Define [form_3_checkdate=" + form_3_checkdate + ", form_3_meeting_venue=" + form_3_meeting_venue
				+ ", form_3_filled_by=" + form_3_filled_by + ", form3_chair_person=" + form3_chair_person
				+ ", form3_chair_person_others=" + form3_chair_person_others + ", theme_id=" + theme_id
				+ ", service_action_part_of_engagement=" + service_action_part_of_engagement
				...
				+ ", first_policy_document_action_required=" + first_policy_document_action_required + ", source="
				+ source + "]";
	}
