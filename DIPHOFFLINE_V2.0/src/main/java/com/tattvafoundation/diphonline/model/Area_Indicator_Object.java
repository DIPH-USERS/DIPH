...
public class Area_Indicator_Object {
	...
	public Area_Indicator_Object() {
		
	}

	public Area_Indicator_Object(String area_id, String area_name, String indicator_val, String indicator_id,
	...
	public String toString() {
		return "Area_Indicator_Object [area_id=" + area_id + ", area_name=" + area_name + ", indicator_val="
