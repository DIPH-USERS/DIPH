...
public class EditOptionalIndicatorBean {
	...
	public EditOptionalIndicatorBean() {		
	}
	
	public EditOptionalIndicatorBean(String edit_indicator_area_id, String edit_indicator_name,
			String edit_indicator_desc, String edit_indicator_numerator, String edit_indicator_denominator,
			String edit_indicator_source, String edit_indicator_frequency, String edit_indicator_category,
			String indicator_id, String theme, String current_available) {
	...
	public String toString() {
		return "EditOptionalIndicatorBean [edit_indicator_area_id=" + edit_indicator_area_id + ", edit_indicator_name="
				...
				+ indicator_id + ", theme=" + theme + ", current_available=" + current_available + "]";
	}
