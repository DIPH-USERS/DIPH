...
public class Form1AEditUpdate {
	...
	public Form1AEditUpdate() {
		
	}

	public Form1AEditUpdate(String date_of_verification, String filled_by, String verified_by_name,
			String verified_by_name_actual_name, String doc_db_check_id, String district, String cycle, String year,
			String userid, String completed, List<Form1ASaveDocumentsArray> large_scale_district_array,
			List<Form1ASaveDocumentsArray> private_sec_array, List<Form1ASaveDocumentsArray> non_health_dept_array,
			List<Form1ASaveDocumentsArray> health_dept_array, List<Form1ASaveDocumentsArray> district_policy_array,
			List<Form1ASaveDocumentsArray> state_policy_array) {
	...
	public String toString() {
		return "Form1AEditUpdate [date_of_verification=" + date_of_verification + ", filled_by=" + filled_by
				+ ", verified_by_name=" + verified_by_name + ", verified_by_name_actual_name="
				+ verified_by_name_actual_name + ", doc_db_check_id=" + doc_db_check_id + ", district=" + district
