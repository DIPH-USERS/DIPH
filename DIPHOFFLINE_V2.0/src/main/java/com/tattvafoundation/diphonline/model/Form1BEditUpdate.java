...
public class Form1BEditUpdate {
	...
	private List<Area_Indicator_Save_Edit> total_coverage_indi;
	...
	public Form1BEditUpdate() {
		
	}



	public Form1BEditUpdate(String date_of_verification, String filled_by, String verified_by_name,
			...
			String district, String cycle, String year, String userid, String completed, String dist_demogra_dtl_id,
			List<Area_Indicator_Save_Edit> total_coverage_indi, List<Form1BSaveDocumentsArray> infra_array,
	...
	public List<Area_Indicator_Save_Edit> getTotal_coverage_indi() {
		return total_coverage_indi;
	}



	public void setTotal_coverage_indi(List<Area_Indicator_Save_Edit> total_coverage_indi) {
		this.total_coverage_indi = total_coverage_indi;
	}
	...
	public String toString() {
		return "Form1BEditUpdate [date_of_verification=" + date_of_verification + ", filled_by=" + filled_by
				...
				+ ", year=" + year + ", userid=" + userid + ", completed=" + completed + ", dist_demogra_dtl_id="
				+ dist_demogra_dtl_id + ", total_coverage_indi=" + total_coverage_indi + ", infra_array=" + infra_array
				+ ", fina_array=" + fina_array + ", supp_array=" + supp_array + ", tech_array=" + tech_array
				+ ", hr_array=" + hr_array + ", key_ngo_info_array=" + key_ngo_info_array + ", key_ngo_source_array="
