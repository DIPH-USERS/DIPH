...
public class ServiceUtil {
	...
	public static Form1BSave form1BViewToForm1BSaveConverter(Form1AView form1AView, Form1BView form1BView,
		...
		form1BSave.setAvailable_functional_infra(form1BView.getInfra_array().get(0).getDocument_available_functional());
		...
		form1BSave.setAvailable_functional_fina(form1BView.getFina_array().get(0).getDocument_available_functional());
		...
		form1BSave.setAvailable_functional_supp(form1BView.getSupp_array().get(0).getDocument_available_functional());
		...
		form1BSave.setAvailable_functional_tech(form1BView.getTech_array().get(0).getDocument_available_functional());
