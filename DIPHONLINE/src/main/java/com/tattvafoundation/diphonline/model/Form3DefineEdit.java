...
public class Form3DefineEdit {
	...
	private List<Form3DefineCommonArray> service_array;
	private List<Form3DefineCommonArray> workforce_array;
	private List<Form3DefineCommonArray> supplies_array;
	private List<Form3DefineCommonArray> health_array;
	private List<Form3DefineCommonArray> finance_array;
	private List<Form3DefineCommonArray> policy_array;
	
	
	private List<Form3DefineCommonArray> service_array_insert;
	private List<Form3DefineCommonArray> workforce_array_insert;
	private List<Form3DefineCommonArray> supplies_array_insert;
	private List<Form3DefineCommonArray> health_array_insert;
	private List<Form3DefineCommonArray> finance_array_insert;
	private List<Form3DefineCommonArray> policy_array_insert;
	
	public Form3DefineEdit() {
		
	}

	public Form3DefineEdit(String form_3_checkdate, String form_3_meeting_venue, String form_3_filled_by,
			...
			String cycle, String year, String userid, String completed, String form_3_id, List<Form3DefineCommonArray> service_array,
			List<Form3DefineCommonArray> workforce_array, List<Form3DefineCommonArray> supplies_array,
			List<Form3DefineCommonArray> health_array, List<Form3DefineCommonArray> finance_array,
			List<Form3DefineCommonArray> policy_array, List<Form3DefineCommonArray> service_array_insert,
			List<Form3DefineCommonArray> workforce_array_insert, List<Form3DefineCommonArray> supplies_array_insert,
			List<Form3DefineCommonArray> health_array_insert, List<Form3DefineCommonArray> finance_array_insert,
			List<Form3DefineCommonArray> policy_array_insert, String source) {
		...
		this.service_array_insert = service_array_insert;
		this.workforce_array_insert = workforce_array_insert;
		this.supplies_array_insert = supplies_array_insert;
		this.health_array_insert = health_array_insert;
		this.finance_array_insert = finance_array_insert;
		this.policy_array_insert = policy_array_insert;
		this.source = source;
	}
	...
	public List<Form3DefineCommonArray> getService_array() {
		return service_array;
	}

	public void setService_array(List<Form3DefineCommonArray> service_array) {
		this.service_array = service_array;
	}

	public List<Form3DefineCommonArray> getWorkforce_array() {
		return workforce_array;
	}

	public void setWorkforce_array(List<Form3DefineCommonArray> workforce_array) {
		this.workforce_array = workforce_array;
	}

	public List<Form3DefineCommonArray> getSupplies_array() {
		return supplies_array;
	}

	public void setSupplies_array(List<Form3DefineCommonArray> supplies_array) {
		this.supplies_array = supplies_array;
	}

	public List<Form3DefineCommonArray> getHealth_array() {
		return health_array;
	}

	public void setHealth_array(List<Form3DefineCommonArray> health_array) {
		this.health_array = health_array;
	}

	public List<Form3DefineCommonArray> getFinance_array() {
		return finance_array;
	}

	public void setFinance_array(List<Form3DefineCommonArray> finance_array) {
		this.finance_array = finance_array;
	}

	public List<Form3DefineCommonArray> getPolicy_array() {
		return policy_array;
	}

	public void setPolicy_array(List<Form3DefineCommonArray> policy_array) {
		this.policy_array = policy_array;
	}

	public List<Form3DefineCommonArray> getService_array_insert() {
		return service_array_insert;
	}

	public void setService_array_insert(List<Form3DefineCommonArray> service_array_insert) {
		this.service_array_insert = service_array_insert;
	}

	public List<Form3DefineCommonArray> getWorkforce_array_insert() {
		return workforce_array_insert;
	}

	public void setWorkforce_array_insert(List<Form3DefineCommonArray> workforce_array_insert) {
		this.workforce_array_insert = workforce_array_insert;
	}

	public List<Form3DefineCommonArray> getSupplies_array_insert() {
		return supplies_array_insert;
	}

	public void setSupplies_array_insert(List<Form3DefineCommonArray> supplies_array_insert) {
		this.supplies_array_insert = supplies_array_insert;
	}

	public List<Form3DefineCommonArray> getHealth_array_insert() {
		return health_array_insert;
	}

	public void setHealth_array_insert(List<Form3DefineCommonArray> health_array_insert) {
		this.health_array_insert = health_array_insert;
	}

	public List<Form3DefineCommonArray> getFinance_array_insert() {
		return finance_array_insert;
	}

	public void setFinance_array_insert(List<Form3DefineCommonArray> finance_array_insert) {
		this.finance_array_insert = finance_array_insert;
	}

	public List<Form3DefineCommonArray> getPolicy_array_insert() {
		return policy_array_insert;
	}

	public void setPolicy_array_insert(List<Form3DefineCommonArray> policy_array_insert) {
		this.policy_array_insert = policy_array_insert;
	}
	...
	public String toString() {
		return "Form3DefineEdit [form_3_checkdate=" + form_3_checkdate + ", form_3_meeting_venue="
				...
				+ ", form_3_id=" + form_3_id + ", source=" + source + ", service_array=" + service_array
				+ ", workforce_array=" + workforce_array + ", supplies_array=" + supplies_array + ", health_array="
				+ health_array + ", finance_array=" + finance_array + ", policy_array=" + policy_array
				+ ", service_array_insert=" + service_array_insert + ", workforce_array_insert="
				+ workforce_array_insert + ", supplies_array_insert=" + supplies_array_insert + ", health_array_insert="
				+ health_array_insert + ", finance_array_insert=" + finance_array_insert + ", policy_array_insert="
				+ policy_array_insert + "]";
	}
