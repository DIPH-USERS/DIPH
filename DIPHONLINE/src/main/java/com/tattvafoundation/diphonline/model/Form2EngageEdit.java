...
public class Form2EngageEdit {
	...
	private List<Form2EngagePartBCommonArray> definingprimaryrole_array_insert;
	private List<Form2EngagePartBCommonArray> efforttoaddressissue_array_insert;
	private List<Form2EngagePartBCommonArray> enhanceefficiency_array_insert;
	private List<Form2EngagePartBCommonArray> themeleadbydpt_array_insert;
	
	public Form2EngageEdit() {
		
	}

	public Form2EngageEdit(String form_2_date_of_meeting, String form_2_venue, String form_2_filled,
			...
			List<Form2EngagePartBCommonArray> themeleadbydpt_array,
			List<Form2EngagePartBCommonArray> definingprimaryrole_array_insert,
			List<Form2EngagePartBCommonArray> efforttoaddressissue_array_insert,
			List<Form2EngagePartBCommonArray> enhanceefficiency_array_insert,
			List<Form2EngagePartBCommonArray> themeleadbydpt_array_insert) {
		...
		this.definingprimaryrole_array_insert = definingprimaryrole_array_insert;
		this.efforttoaddressissue_array_insert = efforttoaddressissue_array_insert;
		this.enhanceefficiency_array_insert = enhanceefficiency_array_insert;
		this.themeleadbydpt_array_insert = themeleadbydpt_array_insert;
	}
	...
	public List<Form2EngagePartBCommonArray> getDefiningprimaryrole_array_insert() {
		return definingprimaryrole_array_insert;
	}

	public void setDefiningprimaryrole_array_insert(List<Form2EngagePartBCommonArray> definingprimaryrole_array_insert) {
		this.definingprimaryrole_array_insert = definingprimaryrole_array_insert;
	}

	public List<Form2EngagePartBCommonArray> getEfforttoaddressissue_array_insert() {
		return efforttoaddressissue_array_insert;
	}

	public void setEfforttoaddressissue_array_insert(List<Form2EngagePartBCommonArray> efforttoaddressissue_array_insert) {
		this.efforttoaddressissue_array_insert = efforttoaddressissue_array_insert;
	}

	public List<Form2EngagePartBCommonArray> getEnhanceefficiency_array_insert() {
		return enhanceefficiency_array_insert;
	}

	public void setEnhanceefficiency_array_insert(List<Form2EngagePartBCommonArray> enhanceefficiency_array_insert) {
		this.enhanceefficiency_array_insert = enhanceefficiency_array_insert;
	}

	public List<Form2EngagePartBCommonArray> getThemeleadbydpt_array_insert() {
		return themeleadbydpt_array_insert;
	}

	public void setThemeleadbydpt_array_insert(List<Form2EngagePartBCommonArray> themeleadbydpt_array_insert) {
		this.themeleadbydpt_array_insert = themeleadbydpt_array_insert;
	}

	@Override
	public String toString() {
		return "Form2EngageEdit [form_2_date_of_meeting=" + form_2_date_of_meeting + ", form_2_venue=" + form_2_venue
				...
				+ ", themeleadbydpt_array=" + themeleadbydpt_array + ", definingprimaryrole_array_insert="
				+ definingprimaryrole_array_insert + ", efforttoaddressissue_array_insert="
				+ efforttoaddressissue_array_insert + ", enhanceefficiency_array_insert="
				+ enhanceefficiency_array_insert + ", themeleadbydpt_array_insert=" + themeleadbydpt_array_insert + "]";
	}
