...
public class SendAndroidAllFormsCorrectResponse_NEW implements I_SendAndroidAllForms {
	...
	public SendAndroidAllFormsCorrectResponse_NEW() {
		
	}

	public SendAndroidAllFormsCorrectResponse_NEW(List<Form1ASendAllDataToAndroidBean> form1a,
			...
			List<OptionalindicatorBean> optional_indicators_list, List<Areas_of_Indicators_List> areas_list,
			List<District> districtList, List<Cycle> cyclesList, List<Year> yearList, String error_code,
			String message) {
	...
	public String toString() {
		return "SendAndroidAllFormsCorrectResponse_NEW [form1a=" + form1a + ", form1b=" + form1b + ", form2=" + form2
				...
				+ ", optional_indicators_list=" + optional_indicators_list + ", areas_list=" + areas_list
				+ ", districtList=" + districtList + ", cyclesList=" + cyclesList + ", yearList=" + yearList
