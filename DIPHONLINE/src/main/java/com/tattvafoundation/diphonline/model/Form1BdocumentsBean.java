...
public class Form1BdocumentsBean {
	...
	public Form1BdocumentsBean() {
	}
	
	
	public Form1BdocumentsBean(String auto_id, String hsca_district_demographic_id, String details, String sanctioned,
			String available, String gap, String country_id, String province_id, String district_id, String cycle_id,
	...
	public String toString() {
		return "Form1BdocumentsBean [auto_id=" + auto_id + ", hsca_district_demographic_id="
				+ hsca_district_demographic_id + ", details=" + details + ", sanctioned=" + sanctioned + ", available="
				+ available + ", gap=" + gap + ", country_id=" + country_id + ", province_id=" + province_id
