...
public class Form1BSave {
	...
	private List<Form1BSaveKeyNgoDocumentsArray> key_ngo_info_array;
	private List<Form1BSaveKeyStakeholderDocumentsArray> key_ngo_source_array;
	...
	public Form1BSave(String date_of_verification, String filled_by, String verified_by_name,
			...
			List<Form1BSaveKeyNgoDocumentsArray> key_ngo_info_array,
			List<Form1BSaveKeyStakeholderDocumentsArray> key_ngo_source_array,
			List<Form1BSaveIndicatorsModel> total_coverage_indi, String source) {
	...
	public List<Form1BSaveKeyNgoDocumentsArray> getKey_ngo_info_array() {
		return key_ngo_info_array;
	}

	public void setKey_ngo_info_array(List<Form1BSaveKeyNgoDocumentsArray> key_ngo_info_array) {
		this.key_ngo_info_array = key_ngo_info_array;
	}

	public List<Form1BSaveKeyStakeholderDocumentsArray> getKey_ngo_source_array() {
		return key_ngo_source_array;
	}

	public void setKey_ngo_source_array(List<Form1BSaveKeyStakeholderDocumentsArray> key_ngo_source_array) {
		this.key_ngo_source_array = key_ngo_source_array;
	}
	...
	public String toString() {
		return "Form1BSave [date_of_verification=" + date_of_verification + ", filled_by=" + filled_by
				...
				+ ", total_coverage_indi=" + total_coverage_indi + ", source=" + source + "]";
	}
