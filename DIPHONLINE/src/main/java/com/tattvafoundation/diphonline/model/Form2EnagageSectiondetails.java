...
public class Form2EnagageSectiondetails {

	private String auto_id;
	private String form_2engage_id;
	private String section_name;
	private String section_select;
	...
	public Form2EnagageSectiondetails() {
		
	}
	
	public Form2EnagageSectiondetails(String auto_id, String form_2engage_id, String section_name,
			String section_select, String section_text, String country_id, String province_id, String district_id,
	...
	public String getSection_select() {
		return section_select;
	}

	public void setSection_select(String section_select) {
		this.section_select = section_select;
	}
	...
	public String toString() {
		return "Form2EnagageSectiondetails [auto_id=" + auto_id + ", form_2engage_id=" + form_2engage_id
				+ ", section_name=" + section_name + ", section_select=" + section_select + ", section_text="
				+ section_text + ", country_id=" + country_id + ", province_id=" + province_id + ", district_id="
