...
export class FeedbackFormComponent implements OnInit {
  ...
  onsubmit() {
    //alert(JSON.stringify(this.customer,null,100));
    this.submitted = true;
    ...
    // if (this.customer.region_n == "") {
    //   finalresult = false;
    // }
    // if (this.customer.state_n == "") {
    //   finalresult = false;
    // }
    ...
    if (this.customer.feedback_desc == "") {
      finalresult = false;
    }
    ...
    else  if(this.validate100charactersallowed(this.customer.subject_n)){
      //alert("Alphabets allowed upto 100 characters");
      return;
    }
    else  if(this.validate100charactersallowed(this.customer.feedback_desc)){
      //alert("Alphabets allowed upto 100 characters");
      return;
    }
    ...
    if(this.customer.subject_n != null  && this.customer.subject_n.trim() == ""){
      //alert("Username cannot be empty");
      return;
    }

    if(this.customer.feedback_desc != null  && this.customer.feedback_desc.trim() == ""){
      //alert("Username cannot be empty");
      return;
    }
    ...
    //alert(selectedcountry+" "+selecteddistrict);
    ...
    this._diphHttpClientService.savefeedbackdetails(this.customer)
      .subscribe(
        data => {
