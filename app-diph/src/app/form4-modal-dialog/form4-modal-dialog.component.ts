...
@Component({
  selector: 'app-form4-modal-dialog',
  templateUrl: './form4-modal-dialog.component.html',
  styleUrls: ['./form4-modal-dialog.component.css']
})
export class Form4ModalDialogComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<Form4ModalDialogComponent>,
    ...
    console.log("data.arr = "+JSON.stringify(data.arr,null,1000));
    ...
    if (data.selected_indi == null || data.selected_indi == 'undefined') {
      ...
      this.currentselectedindi = custom_arr;
        ...
        // alert(JSON.stringify(data.selected_indi,null,1000));
...
console.log(this.selectedItems);
  ...
  onItemSelect(item: any) {
    ...
    //alert("this.selectedItems = "+JSON.stringify(this.selectedItems,null,1000));

    let temparr = [];

    //alert("this.area_indicator_obj.all_indicator_names="+JSON.stringify(this.area_indicator_obj.all_indicator_names,null,10000))
   ...
   // alert("Before Splice :: \nindicatorsUpdatedSelectedArray="+JSON.stringify(this.indicatorsUpdatedSelectedArray,null,1000));
    ...
    for (let i = 0; i < temparr.length; i++) {
      ...
      for (let j = 0; j < this.indicatorsUpdatedSelectedArray.length; j++) {
        ...
        if (((obj2.indicator_val == tempobj.indicator_val) && (obj2["indicator_action_type"] != "service_action_arr"))
        || ((obj2.indicator_val == tempobj.indicator_val) && (obj2["indicator_action_type"] != "workforce_action_arr"))
        || ((obj2.indicator_val == tempobj.indicator_val) && (obj2["indicator_action_type"] != "supplies_action_arr"))
        || ((obj2.indicator_val == tempobj.indicator_val) && (obj2["indicator_action_type"] != "health_action_arr"))
        || ((obj2.indicator_val == tempobj.indicator_val) && (obj2["indicator_action_type"] != "finance_action_arr"))
        || ((obj2.indicator_val == tempobj.indicator_val) && (obj2["indicator_action_type"] != "policy_action_arr"))
        ) {
   ...
   // alert("After splice currentselectedindi="+JSON.stringify(this.currentselectedindi,null,100));
